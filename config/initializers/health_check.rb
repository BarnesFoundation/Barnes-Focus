HealthCheck.setup do |config|
  ...
  # Protect health endpoints with basic auth | These default to nil and the endpoint is not protected
  # config.basic_auth_username = 'my_username'
  # config.basic_auth_password = 'my_password'

  # Whitelist requesting IPs | Defaults to blank and allows any IP
