                        ...
                        <div className="carousel-inner">
                            ...
                            <div className="carousel-item">
                                <div className="photo-prompt-screen">
                                    ...
                                    <div className="content">
                                        <h1 className={this.state.selectedLanguage.code === 'ru' ? 'small' : null}>{(this.state.translation) ? this.state.translation.Instruction_snap.text_1.translated_content : `Take a photo to learn more about a work of art in our collection.`}</h1>
                                    </div>
